...
$db = new Database();
$sql = "SELECT id_nit, razon_social, contacto, direccion, correo, telefono, estado, detalles FROM Proveedores";
...
<div class="container mt-5">
    ...
    <div class="mb-3 d-flex gap-2">
        <input type="text" id="filtroInput" class="form-control w-auto" placeholder="Filtrar por razón social" style="max-width:200px;">
    ...
    <div class="mt-4 text-center">
        <button class="btn btn-success">Crear nuevo proveedor</button>
    </div>
</div>
</body>
</html>
